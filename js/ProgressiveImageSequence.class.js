...
function ImageLoader( src ) {
        ...
        if(navigator.userAgent.indexOf('Chrome') > 0){
            if($('#preloadWindow').length == 0){
                $('body').append('<div id="preloadWindow" style="overflow:hidden;visibility:hidden;position:fixed;top: 0;left: 0;width:10px;height:10px;background: yellow;z-index:100;"></div>');
            }
            $('#preloadWindow').html('<img src="' + src + '"/>');
        }
